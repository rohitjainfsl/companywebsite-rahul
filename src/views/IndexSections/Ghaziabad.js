...
export default function LandingPage22() {
  React.useEffect(() => {
  ...
  return (
    <>
      <MetaTags>
        <title>
          Top-Rated Web Development in Ghaziabad | Digital Marketing | No-Code
          Company | Workbinders Pvt. Ltd.
        </title>
        <meta
          id="meta-description"
          name="description"
          content="Empowering Success: WorkBinders Pvt. Ltd. - Your partner for comprehensive solutions. Specializing in web development, digital marketing, no-code innovation, and mobile app development in Ghaziabad. Unlock your business's potential today."
        />
        <meta
          id="og-title"
          property="og:title"
          content=" Top-Rated Web Development in Ghaziabad | Digital Marketing | No-Code Company |
          Workbinders Pvt. Ltd."
        />
      </MetaTags>
      <IndexNavbar />
            ...
            <Row className="row-grid justify-content-between align-items-center text-left">
              <Col lg="6" md="6">
                <h1 className="text-white">
                  ...
                  <span className="text-white">services in Ghaziabad</span>
                </h1>
                <p className="text-white mb-3">
                  Elevate your online presence with our premier Web Development
                  & Digital Marketing services in Ghaziabad. Experience the

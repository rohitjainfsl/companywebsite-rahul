...
export default function LandingPage16() {
  React.useEffect(() => {
  ...
  return (
    <>
      <MetaTags>
        <title>
          Top-Rated Web Development in Kochi | Digital Marketing | No-Code
          Company | Workbinders Pvt. Ltd.
        </title>
        <meta
          id="meta-description"
          name="description"
          content="Empowering Success: WorkBinders Pvt. Ltd. - Your partner for comprehensive solutions. Specializing in web development, digital marketing, no-code innovation, and mobile app development in Kochi. Unlock your business's potential today."
        />
        <meta
          id="og-title"
          property="og:title"
          content=" Top-Rated Web Development in Kochi | Digital Marketing | No-Code Company |
          Workbinders Pvt. Ltd."
        />
      </MetaTags>
      <IndexNavbar />
            ...
            <Row className="row-grid justify-content-between align-items-center text-left">
              <Col lg="6" md="6">
                <h1 className="text-white">
                  ...
                  <span className="text-white">services in Kochi</span>
                </h1>
                <p className="text-white mb-3">
                  Elevate your online presence with our premier Web Development
                  & Digital Marketing services in Kochi. Experience the artistry
                  of our dedicated experts as they weave captivating websites,
                  seamlessly merging brand identity with user-centric design.
                  Our dynamic digital solutions, customized to your business
                  objectives, stand as a testament to innovation. Together with
                  our proven track record, we fuel your online aspirations into
                  thriving reality.
                </p>
